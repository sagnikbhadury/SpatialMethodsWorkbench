...
Use the workbench citation included in the bundle and the method-specific citations added for the selected pipeline. The current software DOI is [10.5281/zenodo.21763796](https://doi.org/10.5281/zenodo.21763796), and the all-versions DOI is [10.5281/zenodo.21763606](https://doi.org/10.5281/zenodo.21763606).
